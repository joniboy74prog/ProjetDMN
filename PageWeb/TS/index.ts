document.addEventListener('DOMContentLoaded', () => {
    ...
    function updateInputBackgroundColor(color: string): void {
        const inputParametres = document.querySelectorAll<HTMLInputElement>('[name^="parametre"]');
    ...
    function updateColors(): void {
        ...
        const boite = document.querySelector<HTMLElement>('.boite');
        const rectangle = document.querySelector<HTMLElement>('.rectangle');
    ...
    const formulaireParametres = document.getElementById('formulaireParametres') as HTMLFormElement;

    formulaireParametres.addEventListener('submit', (event) => {
        event.preventDefault();
        const nombreParametres = parseInt((document.getElementById('nombreParametres') as HTMLInputElement).value, 10);
    ...
    function ajouterParametre(numero: number): void {
    ...
    document.getElementById('boutonEnvoyer').addEventListener('click', () => {
        const inputsParametres = document.querySelectorAll<HTMLInputElement>('[name^="parametre"]');
